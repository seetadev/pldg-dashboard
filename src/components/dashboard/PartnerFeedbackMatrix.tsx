                ...
                <div className="space-y-4">
                    {paginatedEntries.length > 0 ? (paginatedEntries.map(([contributor, feedbacks]) => (
                        <div key={contributor} className="mb-6 border rounded p-4 bg-white shadow-sm">
                            ...
                            <h3 className="text-lg font-bold mb-2 md:hidden">Contributor Address : {contributor.substring(0, 4)}...{contributor.substring(contributor.length - 3, contributor.length)}</h3>
