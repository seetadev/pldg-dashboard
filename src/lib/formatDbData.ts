...
export default function normalizeEngagementData(
  ...
  const normalized: EngagementData = {
    ...
    'Describe your work with the tech partner':
      record['Describe your work with the tech partner'] || '',
    'Did you work on an issue, PR, or project this week?':
      record['Did you work on an issue, PR, or project this week?'] || '',
    'How many issues, PRs, or projects this week?':
      record['How many issues, PRs, or projects this week?'] || '',
